...
const BookSearchFilter: React.FC<TBookSearchFilterProps> = ({ value, onChange, onClear, containerClassName, searchFilterRef }) => (
  <div className={containerClassName} ref={searchFilterRef}>
